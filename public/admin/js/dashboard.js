    ...
    // Open the chat link in a new popup window
    $('#openChatPopup').on('click', function () {
      // Assuming you want to open content from an external URL
      const chatUrl = 'https://app.crisp.chat/website/59710448-b5ac-48b6-851e-1d76f304fb54/inbox/';

      // Open a new popup window
      const popup = window.open(chatUrl, 'ChatPopup', 'width=800,height=600,resizable=yes,scrollbars=yes');
    ...
    if ($("#activity-chart").length) {
      ...
      var activityChart = new Chart(activityChartCanvas, {
        ...
        data: {
          ...
          datasets: [{
              label: 'Profit',
              data: [300, 300, 340, 320, 315, 270, 290, 310, 340, 335, 300, 320, 300, 340, 320, 315, 270, 290, 310, 340, 335, 300, 320, 300, 340, 320, 315, 270, 290, 310, 340, 335, 300, 320, 300, 340, 320, 315, 270, 290, 310, 340, 335, 300],
              backgroundColor: '#ffbf36'
            },
            {
              label: 'Target',
